    ...
    <Element name="sponser">
            <div className='p-10 lg:p-24 flex flex-col justify-center items-center w-screen bg-gray-950 text-slate-200'>
                <div className='flex flex-col space-y-20 justify-center items-center'>
                    <h1 className='text-6xl p-5 border-red-600 border-b-4'>Sponsors</h1>
                    ...
                    <h2 className='text-center text-4xl'>Thank you to all our Sponsors!</h2>
                </div>
                ...
                <div className='mt-24 text-center'>
                    <p className='text-xl'>
                        ...
                        to our engaged audience. Together, we can bring this project to life and drive meaningful changes.
